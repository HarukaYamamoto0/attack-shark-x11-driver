...
| 25     | Motion Sync  (not confirmed)    | `uint8`     | `0x01` to enable, `0x00` to disable                              |
| 26-43  | Fixed Data                      | `uint8[18]` | Internal fixed values and reserved space                         |
| 44     | LOD (Lift Off)  (not confirmed) | `uint8`     | `0x01` (1mm), `0x02` (2mm)                                       |
| 45     | Fixed                           | `uint8`     | Fixed `0x00`                                                     |
| 46     | Debounce Time (not confirmed)   | `uint8`     | Click delay in ms (usually `0x01` to `0x14` / 1-20ms)            |
| 47-49  | Fixed Data                      | `uint8[3]`  | Internal fixed values and reserved space                         |
